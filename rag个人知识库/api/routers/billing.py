...
@router.get("/api/billing/summary", response_model=BillingSummaryOut)
...
@router.get("/api/billing/usage", response_model=UsageListOut)
...
@router.get("/api/admin/billing/overview", response_model=AdminBillingOverviewOut)
...
@router.get("/api/admin/billing/users", response_model=AdminUserUsageListOut)
